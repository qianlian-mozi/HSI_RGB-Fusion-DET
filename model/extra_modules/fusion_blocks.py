# ！ forks from the paper [CFT](https://github.com/DocF/multispectral-object-detection), 
# TODO: the infrared ray map labels in certain areas have not yet been replaced with hyperspectral map labels. Hope after the allignment, HSI image works the same role as infrared image in this method.
import math
...
__all__ = ['SelfAttention', 'myTransformerBlock', 'GPT']
...
class SelfAttention(nn.Module):
    ...
    def __init__(self, d_model, d_k, d_v, h, attn_pdrop=.1, resid_pdrop=.1):
        ...
        # ！ K,V projection could be optimized
